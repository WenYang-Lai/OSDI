...
static void trap_page_fault_handler(struct Trapframe*);
...
static void
trap_page_fault_handler(struct Trapframe *tf)
{
	uint32_t va = rcr2();
	cprintf("[0316025] Page fault @ %p", va);
	while(1);
}
void trap_init()
{
